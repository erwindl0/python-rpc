 ...
 *******************************************************************************/
package uk.ac.diamond.python.service.example;
 ...
 * <p>
 * To try this, run all uk.ac.diamond... bundles in an Equinox + console and use the contributed
 ...
 * <em>-Dorg.passerelle.python.scripts.system=${workspace_loc}/uk.ac.diamond.python.service/scripts</em>
 * </p>
 *
 */
public class TestRunner implements CommandProvider {
	...
	public void _runScript(CommandInterpreter ci) {
		...
		script = System.getProperty("org.foobar.python.scripts.user",
				"C:/data/workspaces/python-rpc/uk.ac.diamond.python.service.example/scripts")
